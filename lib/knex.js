 ...
 * @param {String} [opts.queryDurarionName="knex_query_duration_seconds"]
 ...
 * @param {String} [opts.queryErrorName="knex_query_errors_total"]
...
function knexExporter(
  ...
  {
    // Query duration
    queryDurarionName = 'knex_query_duration_seconds',
    queryDurarionNameBuckets = [0.003, 0.03, 0.1, 0.3, 1.5, 10],
    // Query error
    queryErrorName = 'knex_query_errors_total',
